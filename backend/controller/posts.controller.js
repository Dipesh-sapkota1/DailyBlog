...
import authenticator from "./auth.controller.js";
...
const editBlog = (req, res) =>{
   ...
   if(index !== -1) {
        ...
        blogs[index].preview = cutParagraph(req.body.description || currBlog.description); 
        if(req.body.author) blogs[index].author = req.body.title || currBlog.author; 
